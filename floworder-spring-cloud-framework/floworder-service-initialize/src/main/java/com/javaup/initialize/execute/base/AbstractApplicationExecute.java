package com.javaup.initialize.execute.base;

import com.javaup.initialize.base.InitializeHandler;
...
public abstract class AbstractApplicationExecute {
    ...
    public void execute(){
        ...
        initializeHandlerMap.values()
                ...
                .forEach(initializeHandler -> initializeHandler.executeInit(applicationContext));
    }
